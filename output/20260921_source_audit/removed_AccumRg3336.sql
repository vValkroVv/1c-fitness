...
SELECT CONVERT(varchar(8),j._RecorderTRef,2) recorder_type,
            ...
            j._RecordKind record_kind,SUM(j._Fld3339) removed_amount_or_quantity,
            ...
            FROM [FitnessRestored_20260630_original].dbo.[_AccumRg3336] j LEFT JOIN [FitnessRestored_20260630_macos].dbo.[_AccumRg3336] s
