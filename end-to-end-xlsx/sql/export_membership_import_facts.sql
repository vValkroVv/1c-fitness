SELECT
    ...
    CONVERT(varchar(19), financial_sale_document_datetime, 120)
        AS financial_sale_document_datetime,
    ...
    CONVERT(varchar(19), financial_register_last_movement_datetime, 120)
        AS financial_register_last_movement_datetime,
