...
FROM [FitnessRestored_20260630_macos].dbo._Document163 d
JOIN [FitnessRestored_20260630_macos].dbo._Reference72 p ON p._IDRRef=d._Fld1446RRef
LEFT JOIN [FitnessRestored_20260630_macos].dbo._InfoRg3060 r ON r._Fld3061RRef=d._IDRRef
LEFT JOIN [FitnessRestored_20260630_macos].dbo._Reference5062 st ON st._IDRRef=r._Fld5960RRef
