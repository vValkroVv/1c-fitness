...
SELECT source, COUNT_BIG(*) AS total_documents,
 SUM(CASE WHEN event_at>'2026-09-20 20:12:12' AND event_at<='2026-09-22 20:12:12' THEN 1 ELSE 0 END) AS between_finish_and_cutoff,
 SUM(CASE WHEN event_at>'2026-09-20 20:12:12' AND event_at<='2026-09-22 20:12:12' AND posted_unmarked=1 THEN 1 ELSE 0 END) AS posted_between_finish_and_cutoff,
 SUM(CASE WHEN event_at>'2026-09-22 20:12:12' THEN 1 ELSE 0 END) AS after_cutoff,
 SUM(CASE WHEN event_at='2026-09-22 20:12:12' THEN 1 ELSE 0 END) AS exactly_at_cutoff,
