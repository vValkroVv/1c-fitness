...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cutoff-at", default="2026-06-30 23:27:03")
    parser.add_argument("--source-stage-dir", default=str(ROOT / "work" / "20260630" / "raw" / "staging"))
    parser.add_argument("--source-reports-dir", default=str(ROOT / "work" / "20260630" / "raw" / "reports"))
    parser.add_argument("--output-stage-dir", default=str(ROOT / "work" / "20260630" / "owner" / "staging"))
    parser.add_argument("--output-reports-dir", default=str(ROOT / "work" / "20260630" / "owner" / "reports"))
