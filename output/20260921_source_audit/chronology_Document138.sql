...
SELECT '_Document138' table_name,COUNT_BIG(*) added_total,
            ...
            FROM [FitnessRestored_20260630_macos].dbo.[_Document138] s LEFT JOIN [FitnessRestored_20260630_original].dbo.[_Document138] j ON j._IDRRef=s._IDRRef
